...
In my app.js line 13–31, i also made a clear distinction between public and private methods — such as generatePassword() (public) vs #handleGeneration() (private). This made it easier to understand what should be accessed from outside the class and what should stay internal.
